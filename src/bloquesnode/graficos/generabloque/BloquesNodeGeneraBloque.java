 ...
 * @author mcarballo
 */
public class BloquesNodeGeneraBloque {
    /**
     *
     */
     ...
     *
     */
    public BloquesNodeTextureAtlas atlas;
    /**
     *
     */
    public BloquesNodeGenericos bloquesGenericos;
     ...
     * @param app
     */
    public BloquesNodeGeneraBloque(Application app){
        this.app = (SimpleApplication) app;
        this.assetManager = this.app.getAssetManager();
        
        atlas = new BloquesNodeTextureAtlas(app);
        atlas.setTexturesInAtlas();
        
        bloquesGenericos = new BloquesNodeGenericos();
    }
    ...
    public Node makeBloque(int tamano,String tipo) {        
        ...
        BloquesNodeGenericosDatos bloquesDatos = bloquesGenericos.getBloqueTipo(tipo);
    ...
    public Node getBloqueGenerado(String nomBloque){        
        ...
        if (bloqueGenerado != null){
            ...
            BloquesNodeGenericosDatos bloquesDatos = bloquesGenericos.getBloqueTipo(nomBloque);
